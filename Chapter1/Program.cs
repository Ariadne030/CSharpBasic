...
namespace chapter1
{
    internal class Program
    {
         class MyClass
        {
            ...
            private int myPrivateInt; //클래스 내에서만 접근 가능, 접근 최대한 막음
            protected int myProtectedInt; // 중간, 클래스와 자식에게만 접근 허용
            internal int myInternalInt; // public 이랑 비슷, 같은 dll 내에서 접근 허용
            public int myPublicInt; // 어디서나 접근 가능    접근 -> 읽고 쓰고 수정하는 것
